        ...
        <div x-show="show" class="relative mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl sm:w-full sm:max-w-4xl sm:mx-auto" x-transition:enter="ease-out duration-300"
            ...
            <div class="px-6 py-4">
                ...
                <div class="relative w-full mt-4 space-y-2">
                    ...
                    <x-page-composer.faq-item faqId="3">
                    ...
                    <x-page-composer.faq-item faqId="4">
                    ...
                    <x-page-composer.faq-item faqId="5">
                    ...
                    <x-page-composer.faq-item faqId="6">
                    ...
                    <x-page-composer.faq-item faqId="7">
                    ...
                    <x-page-composer.faq-item faqId="8">
                    ...
                    <x-page-composer.faq-item faqId="9">
                    ...
                    <x-page-composer.faq-item faqId="10">
                    ...
                    <x-page-composer.faq-item faqId="13">
            ...
            <div class="px-6 py-4 text-right bg-gray-100">
                <x-page-composer.button @click="show = false">{{ __('Close') }}</x-page-composer.button>
            </div>
        </div>
    </div>
</div>
