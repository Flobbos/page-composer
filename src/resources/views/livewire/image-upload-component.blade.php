        ...
        <div class="space-y-1 text-center">
            @if ($photo)
                <div class="relative rounded-lg">
                    ...
                    <x-heroicon-o-check-circle class="absolute w-6 h-6 text-green-600 bg-white rounded-full shadow-md cursor-pointer right-4 -top-2 hover:text-green-900" wire:click="upload" />
