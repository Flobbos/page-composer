<div x-data="{ showLanguageAdd: @entangle('showLanguageAdd') }">
    <!-- The trigger/button can go here if needed -->

    <template x-teleport="body">
        <div class="fixed inset-0 z-30 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-cloak x-show="showLanguageAdd">
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-cloak x-show="showLanguageAdd" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                    ...
                    @click.away="showLanguageAdd = false" class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white shadow-2xl rounded-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
